/* global ZXing:true */
jQuery.sap.registerModulePath("ExtScanner","ExtScanner");
sap.ui.define(
  [
    'sap/ui/core/Control',
    'jquery.sap.global',
    ...
    'sap/ui/Device',
    'com/snet/re/order/zreturnorders/controls/libs/zxingjs0153.min',
    'com/snet/re/order/zreturnorders/controls/ExtScanner'

  ],
  function(Control, jQuery, JSONModel, MessageToast, ResponsivePopover, List, DisplayListItem, Device,zxingjs0153,extScanner) {
    'use strict';

    return Control.extend('com.snet.re.order.zreturnorders.controls.ExtScanner', {
      metadata: {
        manifest: 'json',
        properties: {
      ...
      getSettingsPopover: function() {
        if (!this.oSettingsPopover) {
          this.oSettingsPopover = sap.ui.xmlfragment(this.getId(), 'com.snet.re.order.zreturnorders.view.fragment.settingsPopover', this);
      ...
      _getScanDialog: function() {
        if (!this._oTD) {
          this._oTD = sap.ui.xmlfragment(this.getId(), 'com.snet.re.order.zreturnorders.view.fragment.scanDialog', this);
      ...
      _getInputDialog: function() {
        if (!this._oID) {
          this._oID = sap.ui.xmlfragment(this.getId(), 'com.snet.re.order.zreturnorders.view.fragment.inputDialog', this);
      ...
      _getDialogHeader: function() {
        if (!this._oHeader) {
          this._oHeader = sap.ui.xmlfragment(this.getId(), 'com.snet.re.order.zreturnorders.view.fragment.toolbar', this);
