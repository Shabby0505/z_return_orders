		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Return Orders",
									"targetURL": "#comsnetreorderzreturnorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsnetreorderzreturnorders-display": {
								"semanticObject": "comsnetreorderzreturnorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.snet.re.order.zreturnorders",
									"url": sap.ui.require.toUrl("com/snet/re/order/zreturnorders")
								}
							}
						}
					}
